...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (113, 220, 310, 76) action Start ()
        hotspot (113, 340, 250, 73) action ShowMenu ("load")
        hotspot (113, 463, 435, 75) action ShowMenu ("preferences")
        hotspot (113, 588, 331, 74) action ShowMenu ("about")
        hotspot (113, 915, 170, 55) action Quit (confirm=True)
        hotspot (113, 844, 172, 65) action ShowMenu ("help")
        hotspot (1285, 900, 650, 100) action ShowMenu ( "DISFORIYA")
